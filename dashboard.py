...
class IMS:
    def __init__(self,root):
        ...
        #===footer====
        lbl_footer=Label(self.root,text="SAS-Stock Administration System | Developed by Yash\nFor any Technical Issue Contact: 7566377112",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.update_content()
