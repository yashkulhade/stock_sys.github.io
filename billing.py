...
class BillClass:
    def __init__(self,root):
        ...
        self.root.title("Stock Administration System | Developed by Yash")
        self.root.config(bg="white")
        self.cart_list=[]
        self.chk_print=0
        #===title====
        self.icon_title=PhotoImage(file="Images/logo1.png")
        title=Label(self.root,text="Stock Administration System",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        #===clock====
        self.lbl_clock=Label(self.root,text="Welcome to Stock Administration System\t\t Date: DD-MM-YY\t\t Time: HH:MM:SS",font=("times new roman",15),bg="#4d636d",fg="white")
        ...
        #=============Footer=========================
        footer=Label(self.root,text="SAS-Stock Administration System | Developed by Yash\nFor any Technical Issue Contact: 7566377112",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#=============================All Functions=================
    ...
    def generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            fp.close()
            messagebox.showinfo('Saved',"Bill has been generatedd/Save in Backend",parent=self.root)
            self.chk_print=1
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ-Inventory
\t Phone No. 7566377112 , Bhopal-462003
{str("="*47)}
...
{str("="*47)}\n
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(text=f"Welcome to Stock Administration System\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
